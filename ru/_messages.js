...
Blockly.Msg.ru.switch_language_to_russian = {
  ...
  init: function() {
    ...
    Blockly.Msg.REPL_COMPANION_OUT_OF_DATE1 = 'Версия Companion, которую вы используете, устарела.<br/><br/>Эта версия Kodular должна использоваться с версией Companion.';
    ...
    Blockly.Msg.REPL_HELPER_NOT_RUNNING = 'Запуск AI не работает <br /><a href="https://starter.kodular.io" target="_blank">Нужна помощь?</a>';
    ...
    Blockly.Msg.REPL_NOW_DOWNLOADING = 'Загружается обновление с сервера Kodular, пожалуйста, подождите';
    Blockly.Msg.REPL_NO_ERROR_FIVE_SECONDS = '<br/><i>Внимание:</i>&nbsp;Отчет о другой ошибке появится не ранее, чем через 5 секунд.';
    Blockly.Msg.REPL_NO_START_EMULATOR = 'Невозможно запустить MIT Kodular Companion с эмулятором';
    ...
    Blockly.Msg.REPL_UNABLE_TO_LOAD = 'Не могу загрузить обновление с сервера Kodular.';
    Blockly.Msg.REPL_UNABLE_TO_LOAD_NO_RESPOND = 'Невозможно загрузать обновление с сервера Kodular (сервер не отвечает)';
    Blockly.Msg.REPL_UNABLE_TO_UPDATE = 'Не могу отправить обновление на устройство/эмулятор';
    Blockly.Msg.REPL_UPDATE_INFO = 'На ваше устройство установлено дополнение. Посмотрите на экран вашего устройство и подтвердите установку программы. <br /><br />Важно: когда установка закончится, нажмите "ЗАВЕРШИТЬ"(а не открыть). Затем перейдите в Kodular в вашем браузере, нажмите на "Подключить" и выберите "Переподключиться". Затем переподключите ваше устройство.';
