...
Blockly.Msg.pt.switch_language_to_portuguese = {
  ...
  init: function() {
    ...
    Blockly.Msg.REPL_NOW_DOWNLOADING = 'Uma atualização está a ser descarregada a partir do servidor do Kodular, por favor aguarde';
    ...
    Blockly.Msg.REPL_UNABLE_TO_LOAD_NO_RESPOND = 'Impossível descarregar a atualização do servidor do Kodular (o servidor não responde)';
