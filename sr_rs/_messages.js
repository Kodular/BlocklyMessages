...
goog.provide('AI.Blockly.Msg.sr_rs');

goog.require('Blockly.Msg.sr_rs');
...
Blockly.Msg.sr_rs.switch_language_to_serbian = {
  // Switch language to English.
  category: '',
  helpUrl: '',
  init: function() {
// Context menus.
    Blockly.Msg.UNDO = 'Poništi operaciju';
    ...
    Blockly.Msg.CONFIRM_DELETE = 'Potvrdi brisanje';
    ...
    Blockly.Msg.DISABLE_BLOCK = 'Deaktiviraj blokove';
    Blockly.Msg.ENABLE_BLOCK = 'Aktiviraj blokove';
