...
Blockly.Msg.nl.switch_language_to_dutch = {
  ...
  init: function() {
    ...
    Blockly.Msg.CONNECT_TO_DO_IT = 'U moet verbonden zijn met de Kodular Companion app of emulator om "Doe het" te gebruiken';
    ...
    Blockly.Msg.REPL_NOW_DOWNLOADING = 'We downloaden nu een update van de Kodular server.  Even geduld aub.';
    ...
    Blockly.Msg.BACKPACK_DOCUMENTATION = 'De Rugzak is een knip/plak functie. Het laat toe om blokken te kopieren van een project of scherm  en ze in een ander scherm of project te plakken.  Om te kopieren sleep je de blokken in de rugzak. Om te plakken klik je op het Rugzak icoon en  sleep je de blokken in de werkplaats.</p><p> De inhoud van de Rugzak blijft behouden tijdens de ganse  Kodular sessie. Als je de Kodular dicht doet, of als je je browser herlaadt,  wordt de Rugzak leeggemaakt.</p><p>Voor meer info en een video, bekijk:</p><p><a href="https://docs.kodular.io/guides/backpack" target="_blank">https://docs.kodular.io/guides/backpack</a>';
    ...
    Blockly.Msg.REPL_STARTING_COMPANION_IN_EMULATOR = 'Kodular Companion App wordt opgestart in de emulator.';
    ...
    Blockly.Msg.REPL_COMPANION_OUT_OF_DATE1 = 'De Kodular Companion die je op je smartphone gebruikt, is verouderd.<br/><br/>Deze versie van de Kodular moet gebruikt worden met Companion versie';
    Blockly.Msg.LANG_TEXT_CHANGECASE_OPERATOR_UPPERCASE = 'hoofdletters';
    Blockly.Msg.LANG_MATH_ARITHMETIC_ADD = '+';
    Blockly.Msg.REPL_COMPANION_VERSION_CHECK = 'Versie controle van de Kodular Companion';
    ...
    Blockly.Msg.REPL_NETWORK_ERROR_RESTART = 'Netwerk Communicatie Fout met de Kodular Companion. <br />Probeer eens de smartphone te herstarten en opnieuw te connecteren.';
    ...
    Blockly.Msg.REPL_UNABLE_TO_LOAD = 'Opladen naar de Kodular server mislukt';
    ...
    Blockly.Msg.REPL_NO_START_EMULATOR = 'Het is niet gelukt de MIT Kodular Companion te starten in de Emulator';
    ...
    Blockly.Msg.REPL_UPDATE_INFO = 'De update wordt nu geïnstalleerd op je toestel. Hou je scherm (of emulator) in het oog en keur de installatie goed wanneer je dat gevraagd wordt.<br /><br />BELANGRIJK: Wanneer de update afloopt, kies "VOLTOOID" (klik niet op "open"). Ga dan naar Kodular in je web browser, klik op het "Connecteer" menu en kies "Herstart Verbinding". Verbind dan het toestel.';
    ...
    Blockly.Msg._RENAME_VARIABLE_TITLE = 'Hernoem alle "%1" variabelen naar:';
    ...
    Blockly.Msg.REPL_FACTORY_RESET = 'Deze probeert jouw Emulator te herstellen in zijn initiële staat. Als je eerder je Kodular Companion had geupdate in de emulator, ga je dit waarschijnlijk op nieuw moeten doen. ';
    ...
    Blockly.Msg.REPL_HELPER_NOT_RUNNING = 'De aiStarter helper lijkt niet opgestart<br /><a href="https://starter.kodular.io" target="_blank">hulp nodig?</a>';
    ...
    Blockly.Msg.REPL_UNABLE_TO_LOAD_NO_RESPOND = 'Kan geen update laden van de Kodular server (de server antwoordt niet)';
